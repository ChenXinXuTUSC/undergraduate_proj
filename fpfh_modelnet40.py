...
if __name__ == "__main__":
    ...
    for points1, points2, T_gdth, sample_name in dataloader:
        ...
        keyptsdict1 = utils.iss_detect(coords1, args.ICP_radius * 1.5)
        keyptsdict2 = utils.iss_detect(coords2, args.ICP_radius * 1.5)
        ...
        coords1_o3d.estimate_normals(search_param=o3d.geometry.KDTreeSearchParamHybrid(radius=args.ICP_radius*2.0, max_nn=30))
        coords2_o3d.estimate_normals(search_param=o3d.geometry.KDTreeSearchParamHybrid(radius=args.ICP_radius*2.0, max_nn=30))
